...
*   **Dynamic Chapter Generation**: Users can request a new lessonChapter on a specific topic, language, and difficulty level.
...
*   **Real-time Progress Updates**: The frontend receives live progress updates via WebSockets for long-running jobs like lessonChapter generation.
...
*   `/`
    ...
    *   `frontend/`
        *   `src/`
            ...
            *   `pages/` - Top-level lessonPage components
            *   `shared/`
