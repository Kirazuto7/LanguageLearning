create table conjugation_examples (id bigint generated by default as identity, lesson_id bigint not null, conjugated_form TEXT, example_sentence TEXT, infinitive varchar(255), sentence_translation TEXT, primary key (id));
create table conjugation_lesson (id bigint not null, conjugation_rule_name varchar(255), explanation TEXT, primary key (id));
...
create table lesson_books (id bigint generated by default as identity, user_id bigint, difficulty varchar(255), language varchar(255), title varchar(255), primary key (id));
create table lesson_chapters (chapter_number integer not null, book_id bigint, id bigint generated by default as identity, native_title varchar(255) not null, title varchar(255) not null, primary key (id));
create table lesson_pages (page_number integer not null, id bigint generated by default as identity, lesson_chapter_id bigint, lesson_id bigint unique, primary key (id));
create table lesson_questions (id bigint generated by default as identity, lesson_id bigint not null, answer TEXT, question_text TEXT, question_type varchar(255) check (question_type in ('MULTIPLE_CHOICE','FREE_FORM')), primary key (id));
create table lessons (id bigint generated by default as identity, title varchar(255), type varchar(255) check (type in ('VOCABULARY','GRAMMAR','CONJUGATION','PRACTICE','READING_COMPREHENSION')), primary key (id));
...
create table sentences (id bigint generated by default as identity, text TEXT, translation TEXT, primary key (id));
create table settings (auto_speak_enabled boolean default true not null, id bigint generated by default as identity, difficulty varchar(255), language varchar(255), mascot varchar(255) not null, theme varchar(255) not null, primary key (id));
create table short_stories (chapter_number integer not null, id bigint generated by default as identity, story_book_id bigint, genre varchar(255), native_title varchar(255) not null, title varchar(255) not null, topic varchar(255), primary key (id));
create table story_books (id bigint generated by default as identity, user_id bigint, difficulty varchar(255), language varchar(255), title varchar(255), primary key (id));
create table story_pages (page_number integer not null, id bigint generated by default as identity, short_story_id bigint, english_summary TEXT, image_url TEXT, type varchar(255) check (type in ('CONTENT','VOCABULARY')), primary key (id));
create table story_paragraphs (paragraph_number integer not null, id bigint generated by default as identity, story_page_id bigint, content TEXT, primary key (id));
create table story_vocabulary_items (page_number integer not null, id bigint generated by default as identity, story_page_id bigint, translation varchar(255), word varchar(255), primary key (id));
create table users (id bigint generated by default as identity, settings_id bigint unique, password varchar(255), username varchar(255), primary key (id));
...
create table words (id bigint generated by default as identity, english_translation TEXT not null, language varchar(255) not null, details jsonb, primary key (id));
alter table if exists conjugation_examples add constraint FKj8o2sufd445ktfanu03d9s1pp foreign key (lesson_id) references conjugation_lesson;
alter table if exists conjugation_lesson add constraint FK38tvralx9sggqagut8t4sdcj3 foreign key (id) references lessons;
