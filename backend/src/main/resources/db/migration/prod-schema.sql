create table conjugation_examples (created_at timestamp(6) not null default now(), id bigint generated by default as identity, lesson_id bigint not null, conjugated_form TEXT, example_sentence TEXT, infinitive varchar(255), sentence_translation TEXT, primary key (id));
...
create table story_paragraphs (paragraph_number integer not null, created_at timestamp(6) not null default now(), id bigint generated by default as identity, story_page_id bigint, content TEXT, primary key (id));
create table story_vocabulary_items (created_at timestamp(6) not null default now(), id bigint generated by default as identity, story_page_id bigint, translation varchar(255), word varchar(255), primary key (id));
create table users (created_at timestamp(6) not null default now(), id bigint generated by default as identity, settings_id bigint unique, password varchar(255), username varchar(255), primary key (id));
...
alter table if exists conjugation_examples add constraint FKj8o2sufd445ktfanu03d9s1pp foreign key (lesson_id) references conjugation_lessons;
