...
create table users (created_at timestamp(6) not null default now(), id bigint generated by default as identity, settings_id bigint unique, password varchar(255), username varchar(255), refresh_token TEXT, refresh_token_expiry timestamptz(6), primary key (id));
